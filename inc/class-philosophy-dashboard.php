...
class Philosophy_Dashboard {
	...
	public function __construct( $theme = array() ) {
		 ...
		 */
		$methods = get_class_methods( 'Philosophy_Dashboard' );
	...
	public static function get_instance( $theme = array() ) {
		static $inst;
		if ( ! $inst ) {
			$inst = new Philosophy_Dashboard( $theme );
		}
	...
	public function init_dashboard() {
		...
		$dashboard = Philosophy_Dashboard_Setup::get_instance();
	...
	public function epsilon_dashboard( $setup = array() ) {
		$dashboard = new Philosophy_Dashboard_Setup();
