...
class Epsilon_Uninstall_Feedback {
	...
	public function enqueue() {
		wp_enqueue_style(
			'epsilon-feedback',
			get_template_directory_uri() . '/inc/philosophy-framework/epsilon-theme-dashboard/assets/css/feedback.css'

		);
		wp_enqueue_script(
			'epsilon-feedback',
			get_template_directory_uri() . '/inc/philosophy-framework/epsilon-theme-dashboard/assets/js/epsilon-feedback.js',
			array(),
			false,
			true
		);
