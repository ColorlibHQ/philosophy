...
>>>>>>> 5a42a4e760d4c9695deb1c2d83070bd5fb910a24
	...
	public function enqueue() {
		wp_enqueue_style(
			'epsilon-dashboard',
			get_template_directory_uri() . '/inc/philosophy-framework/epsilon-theme-dashboard/assets/css/dashboard.css'

		);
		wp_enqueue_script(
			'epsilon-dashboard',
			get_template_directory_uri() . '/inc/philosophy-framework/epsilon-theme-dashboard/assets/js/epsilon-dashboard.js',
			array(),
			false,
			true
		);
