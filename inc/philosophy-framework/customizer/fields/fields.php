...
Epsilon_Customizer::add_field(
    ...
    array(
        ...
        'layouts'  => array(
            '1' => get_template_directory_uri() . '/inc/philosophy-framework/epsilon-framework/assets/img/one-column.png',
            '2' => get_template_directory_uri() . '/inc/philosophy-framework/epsilon-framework/assets/img/epsilon-section-titleright.jpg',
            '3' => get_template_directory_uri() . '/inc/philosophy-framework/epsilon-framework/assets/img/epsilon-section-titleleft.jpg',
        ),
        'default'  => array(
            'columnsCount' => 1,
            'columns'      => array(
