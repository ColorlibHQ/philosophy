...
function philosophy_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'      => esc_html__( 'Contact Form 7', 'philosophy' ),
			'slug'      => 'contact-form-7',
			'required'  => true,
		),
		
		array(
			'name'      => esc_html__( 'One Click Demo Import', 'philosophy' ),
			'slug'      => 'one-click-demo-import',
			'required'  => true,
		),
		
		array(
			'name'      => esc_html__( 'MailChimp for WordPress', 'philosophy' ),
			'slug'      => 'mailchimp-for-wp',
			'required'  => true,
		),

		array(
			'name'        => esc_html__( 'CMB2', 'philosophy' ),
			'slug'        => 'cmb2',
			'required'  => true,
		),
